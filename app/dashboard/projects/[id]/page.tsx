...
import { KeyMomentsTab } from "@/components/project-tabs/key-moment-tabs";
import { SocialPostsTab } from "@/components/project-tabs/social-post-tab";
...
import { YouTubeTimestampsTab } from "@/components/project-tabs/youtube-timestamp-tab";
...
import { FEATURES } from "@/lib/tierConfigs";
import { PROJECT_TABS } from "@/lib/tabConfigs";
          ...
          >
            ...
            <div className="glass-card rounded-2xl p-4 mb-6 lg:hidden">
              <Select value={activeTab} onValueChange={setActiveTab}>
                ...
                <SelectContent>
                  {PROJECT_TABS.map((tab: typeof PROJECT_TABS[number]) => (
                    <MobileTabItem
                      key={tab.value}
                      tab={tab}
                      project={project}
